package org.gooru.nucleus.dataclass.api.gateway.responses.writers;

import java.nio.charset.StandardCharsets;
import java.util.Map;
import org.gooru.nucleus.dataclass.api.gateway.constants.HttpConstants;
import org.gooru.nucleus.dataclass.api.gateway.responses.transformers.ResponseTransformer;
import org.gooru.nucleus.dataclass.api.gateway.responses.transformers.ResponseTransformerBuilder;
    ...
    if (transformer.transformedStatus() != HttpConstants.HttpStatus.NO_CONTENT.getCode()) {
      final String responseBody =
          ((transformer.transformedBody() != null) && (!transformer.transformedBody().isEmpty()))
              ? transformer.transformedBody().toString()
              : null;
