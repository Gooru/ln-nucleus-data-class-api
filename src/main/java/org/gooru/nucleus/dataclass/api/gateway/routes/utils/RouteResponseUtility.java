...
import org.gooru.nucleus.dataclass.api.gateway.responses.writers.ResponseWriterBuilder;
...
public class RouteResponseUtility {
  ...
  public void responseHandler(final RoutingContext routingContext,
      final AsyncResult<Message<Object>> reply, final Logger LOG) {
    if (reply.succeeded()) {
