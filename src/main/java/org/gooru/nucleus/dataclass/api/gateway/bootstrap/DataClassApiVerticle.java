package org.gooru.nucleus.dataclass.api.gateway.bootstrap;

import org.gooru.nucleus.dataclass.api.gateway.constants.ConfigConstants;
import org.gooru.nucleus.dataclass.api.gateway.routes.RouteConfiguration;
import org.gooru.nucleus.dataclass.api.gateway.routes.RouteConfigurator;
...
/**
 * Created by ashish on 4/12/15. Starts the HTTP gateway for nucleus.
 * <p>
 * This class is the HTTP gateway for nucleus. It starts HTTP server on port specified in
 * configuration file, registers the routes and corresponding handlers.
 */
public class DataClassApiVerticle extends AbstractVerticle {

  private static final Logger LOG = LoggerFactory.getLogger(DataClassApiVerticle.class);

  @Override
  public void start(Future<Void> voidFuture) throws Exception {

    LOG.info("Starting DataClassApiVerticle...");
