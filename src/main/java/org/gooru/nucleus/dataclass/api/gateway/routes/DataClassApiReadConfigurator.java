...
class DataClassApiReadConfigurator implements RouteConfigurator {
  ...
  private static final Logger LOG = LoggerFactory
      .getLogger("org.gooru.nucleus.dataclass.api.gateway.bootstrap.DataClassApiVerticle");
 ...
 // Student Current Resource Location
    ...
    router.get(RouteConstants.ASSESSMENT_STUDENTS_PERF_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_STUDENT_ASSESSMENT_PERF)
          .addHeader(RouteConstants.ID_CLASS, classId).addHeader(RouteConstants.ID_COURSE, courseId)
          .addHeader(RouteConstants.ID_UNIT, unitId).addHeader(RouteConstants.ID_LESSON, lessonId)
    ...
    router.get(RouteConstants.COLLECTION_STUDENTS_PERF_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_STUDENT_COLLECTION_PERF)
          .addHeader(RouteConstants.ID_CLASS, classId).addHeader(RouteConstants.ID_COURSE, courseId)
          .addHeader(RouteConstants.ID_UNIT, unitId).addHeader(RouteConstants.ID_LESSON, lessonId)
    ...
    router.get(RouteConstants.COLLECTION_STUDENT_SUMMARY_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_STUDENT_COLLECTION_SUMMARY)
          .addHeader(RouteConstants.ID_COLLECTION, collectionId)
          .addHeader(RouteConstants.UID_USER, userId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.ASSESSMENT_STUDENT_SUMMARY_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_STUDENT_ASSESSMENT_SUMMARY)
          .addHeader(RouteConstants.ID_COLLECTION, collectionId)
          .addHeader(RouteConstants.UID_USER, userId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
    ...
    router.get(RouteConstants.USER_ALL_SESSION_GET_FOR_ASSESSMENT).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_USER_ALL_ASSESSMENT_SESSIONS)
          .addHeader(RouteConstants.ID_COLLECTION, collectionId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.USER_ALL_SESSION_GET_FOR_COLLECTION).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_USER_ALL_COLLECTION_SESSIONS)
          .addHeader(RouteConstants.ID_COLLECTION, collectionId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.SESSION_TAXONOMY_REPORT_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_SESSION_TAXONOMY_REPORT)
          .addHeader(RouteConstants.ID_SESSION, sessionId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.post(RouteConstants.ALL_CLASSES_PERFORMANCE).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_ALL_STUDENT_CLASSES_PERF);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.post(RouteConstants.STUDENT_LOCATION_ALL_CLASSES).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_STUDENT_LOC_ALL_CLASSES);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
     ...
     * DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
     * .addHeader(MessageConstants.MSG_HEADER_OP,
     * MessageConstants.MSG_OP_STUDENT_PERF_MULT_COLLECTION);
     * eb.send(MessagebusEndpoints.MBEP_DATACLASS_API, new
     * RouteRequestUtility().getBodyForMessage(routingContext), options, reply -> new
    ...
    router.get(RouteConstants.STUDENT_PERF_COURSE_ASSESSMENTS).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_STUDENT_PERF_COURSE_ASSESSMENT);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.STUDENT_PERF_COURSE_COLLECTION).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_STUDENT_PERF_COURSE_COLLECTION);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.COURSE_LEARNER_PERF_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_INDEPENDENT_LEARNER_COURSE_PERF)
          .addHeader(RouteConstants.ID_COURSE, courseId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.UNIT_LEARNER_PERF_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_INDEPENDENT_LEARNER_UNIT_PERF)
    ...
    router.get(RouteConstants.LESSON_LEARNER_PERF_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_INDEPENDENT_LEARNER_LESSON_PERF)
          .addHeader(RouteConstants.ID_COURSE, courseId).addHeader(RouteConstants.ID_UNIT, unitId)
    ...
    router.get(RouteConstants.ASSESSMENT_LEARNER_PERF_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_INDEPENDENT_LEARNER_ASSESSMENT_PERF)
          .addHeader(RouteConstants.ID_COURSE, courseId).addHeader(RouteConstants.ID_UNIT, unitId)
          .addHeader(RouteConstants.ID_LESSON, lessonId)
          .addHeader(RouteConstants.ID_COLLECTION, assessmentId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
    ...
    router.get(RouteConstants.INDEPENDENT_ASSESSMENT_LEARNER_PERF_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_INDEPENDENT_LEARNER_INDEPENDENT_ASSESSMENT_PERF)
          .addHeader(RouteConstants.ID_COLLECTION, assessmentId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.GET_INDEPENDENT_LEARNER_COURSES).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_INDEPENDENT_LEARNER_COURSES);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.LEARNER_LOCATION_ALL_COURSES_GET).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_IND_LEARNER_LOCATION_ALL_COURSES);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.INDEPENDENT_LEARNER_LOCATION_ALL_GET).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_IND_LEARNER_ALL_LOCATION);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.INDEPENDENT_LEARNER_PERF_ALL_GET).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_IND_LEARNER_ALL_PERFORMANCE);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    // Get Independent Learner's Location for all Collections (ClassId = null, CourseId = null,
    // UnitId = null, LessonId = null)
    ...
    router.get(RouteConstants.LEARNER_PERF_ALL_COURSES_GET).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_IND_LEARNER_PERF_ALL_COURSES);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });

    // Get Independent Learner's Performance for Independent Assessments (ClassId = null, CourseId =
    // null, UnitId = null, LessonId = null)
    ...
    // Get Independent Learner's Performance for all Courses (ClassId = null, CourseId = null,
    // UnitId = null, LessonId = null)
    ...
    router.get(RouteConstants.LEARNER_TAXONOMY_SUBJECTS).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_IND_LEARNER_TAX_SUBJECTS);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.LEARNER_COURSES_GET).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_LEARNER_COURSES);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.INDEPENDENT_LEARNER_CURRENT_LOC_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_IND_LEARNER_CURRENT_LOC)
    ...
    router.post(RouteConstants.INDEPENDENT_LEARNER_PERF_ALL_COURSES).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_IND_LEARNER_ALL_COURSES_PERF);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.INDENDEPENDENT_LEARNER_COLLECTION_SUMMARY_GET)
        .handler(routingContext -> {
          String collectionId = routingContext.request().getParam(RouteConstants.ID_COLLECTION);
          String userId = routingContext.request().getParam(RouteConstants.ID_USER);
          DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
              .addHeader(MessageConstants.MSG_HEADER_OP,
                  MessageConstants.MSG_OP_IND_LEARNER_COLLECTION_SUMMARY)
              .addHeader(RouteConstants.ID_COLLECTION, collectionId)
    ...
    router.get(RouteConstants.INDENDEPENDENT_LEARNER_ASSESSMENT_SUMMARY_GET)
        .handler(routingContext -> {
          String collectionId = routingContext.request().getParam(RouteConstants.ID_ASSESSMENT);
          String userId = routingContext.request().getParam(RouteConstants.ID_USER);
          DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
              .addHeader(MessageConstants.MSG_HEADER_OP,
                  MessageConstants.MSG_OP_IND_LEARNER_ASSESSMENT_SUMMARY)
              .addHeader(RouteConstants.ID_COLLECTION, collectionId)
              .addHeader(RouteConstants.ID_USER, userId);
          eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
              new RouteRequestUtility().getBodyForMessage(routingContext), options,
    ...
    router.get(RouteConstants.INDEPENDENT_LEARNER_ALL_SESSION_FOR_ASSESSMENT_GET)
        .handler(routingContext -> {
          String collectionId = routingContext.request().getParam(RouteConstants.ID_COLLECTION);
          DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
              .addHeader(MessageConstants.MSG_HEADER_OP,
                  MessageConstants.MSG_OP_IND_LEARNER_ALL_ASSESSMENT_SESSIONS)
              .addHeader(RouteConstants.ID_COLLECTION, collectionId);
          eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
              new RouteRequestUtility().getBodyForMessage(routingContext), options,
              reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.INDEPENDENT_LEARNER_ALL_SESSION_FOR_COLLECTION_GET)
        .handler(routingContext -> {
          String collectionId = routingContext.request().getParam(RouteConstants.ID_COLLECTION);
          DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
              .addHeader(MessageConstants.MSG_HEADER_OP,
                  MessageConstants.MSG_OP_IND_LEARNER_ALL_COLLECTION_SESSIONS)
              .addHeader(RouteConstants.ID_COLLECTION, collectionId);
          eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
              new RouteRequestUtility().getBodyForMessage(routingContext), options,
              reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.post(RouteConstants.STUDENT_PERF_DAILY_CLASS_ACTIVITY).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_STUDENT_PERF_DAILY_CLASS_ACTIVITY)
          .addHeader(RouteConstants.ID_CLASS, classId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.STUDENT_PERF_DAILY_TIMELY_CLASS_ACTIVITY).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_STUDENT_PERF_DAILY_TIMELY_CLASS_ACTIVITY)
          .addHeader(RouteConstants.ID_CLASS, classId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.DCA_SESSION_TAXONOMY_REPORT_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_DCA_SESSION_TAXONOMY_REPORT)
          .addHeader(RouteConstants.ID_SESSION, sessionId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.DCA_COLLECTION_STUDENT_SUMMARY_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_DCA_STUDENT_COLLECTION_SUMMARY)
          .addHeader(RouteConstants.ID_COLLECTION, collectionId)
          .addHeader(RouteConstants.UID_USER, userId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
    ...
    router.get(RouteConstants.DCA_ASSESSMENT_STUDENT_SUMMARY_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_DCA_STUDENT_ASSESSMENT_SUMMARY)
          .addHeader(RouteConstants.ID_COLLECTION, collectionId)
          .addHeader(RouteConstants.UID_USER, userId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
    ...
    router.get(RouteConstants.DCA_ASSESSMENT_STUDENTS_PERF_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_DCA_STUDENT_ASSESSMENT_PERF)
          .addHeader(RouteConstants.ID_CLASS, classId)
          .addHeader(RouteConstants.ID_COLLECTION, assessmentId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
    ...
    router.get(RouteConstants.DCA_COLLECTION_STUDENTS_PERF_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_DCA_STUDENT_COLLECTION_PERF)
          .addHeader(RouteConstants.ID_CLASS, classId)
          .addHeader(RouteConstants.ID_COLLECTION, collectionId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
    ...
    router.get(RouteConstants.DCA_USER_ALL_SESSIONS_GET_FOR_ASSESSMENT).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_DCA_STUDENT_ASSESSMENT_ALL_SESSIONS)
          .addHeader(RouteConstants.ID_COLLECTION, collectionId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.DCA_CLASS_SUMMARY_FOR_YEAR).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_DCA_CLASS_SUMMARY_MONTHLY)
          .addHeader(RouteConstants.ID_CLASS, classId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.DCA_CLASS_ACTIVITIES_SUMMARY_FOR_MONTH).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_DCA_CLASS_SUMMARY_FOR_MONTH)
          .addHeader(RouteConstants.ID_CLASS, classId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.DCA_CLASS_LEARNERS_SUMMARY_FOR_MONTH).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_DCA_CLASS_USER_SUMMARY_FOR_MONTH)
          .addHeader(RouteConstants.ID_CLASS, classId)
          .addHeader(RouteConstants.ID_COLLECTION, collectionId)
    ...
    router.get(RouteConstants.CA_ASSESSMENT_STUDENTS_SESSION_PERF_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_CA_STUDENT_ASSESSMENT_SESSION_PERF)
          .addHeader(RouteConstants.ID_CLASS, classId)
          .addHeader(RouteConstants.ID_COLLECTION, assessmentId)
          .addHeader(RouteConstants.ID_SESSION, sessionId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
    ...
    router.get(RouteConstants.CA_COLLECTION_STUDENTS_SESSION_PERF_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_CA_STUDENT_COLLECTION_SESSION_PERF)
          .addHeader(RouteConstants.ID_CLASS, classId)
          .addHeader(RouteConstants.ID_COLLECTION, assessmentId)
          .addHeader(RouteConstants.ID_SESSION, sessionId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
    ...
    // DCA: Get All Classes Performance
    router.post(RouteConstants.DCA_ALL_CLASSES_PERFORMANCE).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_DCA_ALL_CLASSES_PERF);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.RUBRICS_QUESTIONS_TO_GRADE_GET).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_RUBRICS_QUESTIONS_TO_GRADE);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.RUBRIC_QUESTION_TO_GRADE_LIST_STUDENTS_GET)
        .handler(routingContext -> {
          String question_id = routingContext.request().getParam(RouteConstants.QUE_ID);
          DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
              .addHeader(MessageConstants.MSG_HEADER_OP,
                  MessageConstants.MSG_OP_RUBRIC_QUESTIONS_STUDENTS_LIST)
    ...
    router.get(RouteConstants.RUBRIC_QUESTION_STUDENT_ANSWERS_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_RUBRIC_QUESTIONS_STUDENT_ANSWERS)
          .addHeader(RouteConstants.QUE_ID, question_id)
    ...
    router.get(RouteConstants.RUBRIC_QUESTION_GRADE_SUMMARY_GET).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_RUBRIC_QUESTIONS_GRADE_SUMMARY)
          .addHeader(RouteConstants.ID_CLASS, classId).addHeader(RouteConstants.ID_COURSE, courseId)
          .addHeader(RouteConstants.ID_COLLECTION, collectionId)
          .addHeader(RouteConstants.QUE_ID, question_id);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
    ...
    router.get(RouteConstants.DATA_REPORTS_FOR_STUDENT).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          ...
          .addHeader(RouteConstants.START_DATE, startDate)
          .addHeader(RouteConstants.END_DATE, endDate);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.post(RouteConstants.NU_COURSES_COMPETENCY_COMPLETION).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_NU_COURSES_COMPETENCY_COMPLETION);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    // ********************************************************************************************************************************
    // TEACHER VIEW: Air Traffic Control Dashboard (ATC): All Students Performance Vs Completion
    // Graph
    router.get(RouteConstants.STUDENTS_PERFORMANCE_VS_COMPLETION).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000).addHeader(
          MessageConstants.MSG_HEADER_OP, MessageConstants.MSG_OP_STUDENTS_PERF_VS_COMPLETION);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
    ...
    router.get(RouteConstants.STUDENTS_COURSE_ALL_ITEMS_PERF).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_STUDENTS_COURSE_ALL_ITEMS_PERF)
          .addHeader(RouteConstants.ID_CLASS, classId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.get(RouteConstants.INDEPENDENT_LEARNER_COURSE_ALL_ITEMS_PERF).handler(routingContext -> {
      ...
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_INDEPENDENT_LEARNER_COURSE_ALL_ITEMS_PERF)
          .addHeader(RouteConstants.ID_COURSE, courseId);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    ...
    router.post(RouteConstants.STUDENTS_PERFORMANCE_ON_SUGGESTIONS).handler(routingContext -> {
      DeliveryOptions options = new DeliveryOptions().setSendTimeout(mbusTimeout * 1000)
          .addHeader(MessageConstants.MSG_HEADER_OP,
              MessageConstants.MSG_OP_STUD_PERFORMANCE_ON_SUGGESTIONS);
      eb.send(MessagebusEndpoints.MBEP_DATACLASS_API,
          new RouteRequestUtility().getBodyForMessage(routingContext), options,
          reply -> new RouteResponseUtility().responseHandler(routingContext, reply, LOG));
    });
