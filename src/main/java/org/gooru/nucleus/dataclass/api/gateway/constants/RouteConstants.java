...
/**
 * Created by ashish on 4/12/15. updated by mukul@gooru for Class Reports - Write/Read APIs
 * 
 */
public final class RouteConstants {
  ...
  // private static final String RUBRIC_GRADING_API_BASE_ROUTE = "/api/rubric-grading/" +
  // RUBRIC_GRADING_API_VERSION + SEP;
  ...
  public static final String COURSE_PEERS_GET = API_BASE_ROUTE + ENTITY_CLASS + SEP + COLON
      + ID_CLASS + SEP + ENTITY_COURSE + SEP + COLON + ID_COURSE + SEP + PEERS;
  ...
  public static final String UNIT_PEERS_GET =
      API_BASE_ROUTE + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + ENTITY_COURSE + SEP + COLON
          + ID_COURSE + SEP + ENTITY_UNIT + SEP + COLON + ID_UNIT + SEP + PEERS;
  ...
  public static final String LESSON_PEERS_GET = API_BASE_ROUTE + ENTITY_CLASS + SEP + COLON
      + ID_CLASS + SEP + ENTITY_COURSE + SEP + COLON + ID_COURSE + SEP + ENTITY_UNIT + SEP + COLON
      + ID_UNIT + SEP + ENTITY_LESSON + SEP + COLON + ID_LESSON + SEP + PEERS;
  ...
  public static final String COURSE_STUDENT_PERF_GET = API_BASE_ROUTE + ENTITY_CLASS + SEP + COLON
      + ID_CLASS + SEP + ENTITY_COURSE + SEP + COLON + ID_COURSE + SEP + PERFORMANCE;
  ...
  public static final String UNIT_STUDENT_PERF_GET =
      API_BASE_ROUTE + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + ENTITY_COURSE + SEP + COLON
          + ID_COURSE + SEP + ENTITY_UNIT + SEP + COLON + ID_UNIT + SEP + PERFORMANCE;
  ...
  public static final String ASSESSMENT_STUDENTS_PERF_GET = API_BASE_ROUTE + ENTITY_CLASS + SEP
      + COLON + ID_CLASS + SEP + ENTITY_COURSE + SEP + COLON + ID_COURSE + SEP + ENTITY_UNIT + SEP
      + COLON + ID_UNIT + SEP + ENTITY_LESSON + SEP + COLON + ID_LESSON + SEP + ENTITY_ASSESSMENT
      + SEP + COLON + ID_COLLECTION + SEP + PERFORMANCE;

  // Get Students Performance In Lesson (getCollectionPerformance)
  // {REST_END_POINT}/api/nucleus-insights/v2/class/{classGooruId}/course/{courseGooruId}/unit/{unitGooruId}/lesson/
  // {lessonGoouId}/collection/{collectionGooruId}/performance
  public static final String COLLECTION_STUDENTS_PERF_GET = API_BASE_ROUTE + ENTITY_CLASS + SEP
      + COLON + ID_CLASS + SEP + ENTITY_COURSE + SEP + COLON + ID_COURSE + SEP + ENTITY_UNIT + SEP
      + COLON + ID_UNIT + SEP + ENTITY_LESSON + SEP + COLON + ID_LESSON + SEP + ENTITY_COLLECTION
      + SEP + COLON + ID_COLLECTION + SEP + PERFORMANCE;
  ...
  public static final String LESSON_STUDENT_PERF_GET = API_BASE_ROUTE + ENTITY_CLASS + SEP + COLON
      + ID_CLASS + SEP + ENTITY_COURSE + SEP + COLON + ID_COURSE + SEP + ENTITY_UNIT + SEP + COLON
      + ID_UNIT + SEP + ENTITY_LESSON + SEP + COLON + ID_LESSON + SEP + PERFORMANCE;
  ...
  public static final String COLLECTION_STUDENT_SUMMARY_GET = API_BASE_ROUTE + ENTITY_COLLECTION
      + SEP + COLON + ID_COLLECTION + SEP + ENTITY_USER + SEP + COLON + UID_USER;

  public static final String ASSESSMENT_STUDENT_SUMMARY_GET = API_BASE_ROUTE + ENTITY_ASSESSMENT
      + SEP + COLON + ID_ASSESSMENT + SEP + ENTITY_USER + SEP + COLON + UID_USER;
  ...
  public static final String SESSION_STATUS_GET = API_BASE_ROUTE_FOR_SESSION + ENTITY_COLLECTION
      + SEP + COLON + ID_COLLECTION + SEP + SESSION + SEP + COLON + ID_SESSION + SEP + STATUS;

  // GET ALL USER SESSIONS
  // {REST_END_POINT}/insights/api/rest/v2/{collectionType}/{contentGooruId}/sessions
  public static final String USER_ALL_SESSION_GET_FOR_ASSESSMENT =
      API_BASE_ROUTE + ENTITY_ASSESSMENT + SEP + COLON + ID_COLLECTION + SEP + SESSIONS;

  public static final String USER_ALL_SESSION_GET_FOR_COLLECTION =
      API_BASE_ROUTE + ENTITY_COLLECTION + SEP + COLON + ID_COLLECTION + SEP + SESSIONS;
  ...
  public static final String ALL_STUDENT_ASSESSMENT_PERF_GET = API_BASE_ROUTE + ENTITY_CLASS + SEP
      + COLON + ID_CLASS + SEP + ENTITY_COURSE + SEP + COLON + ID_COURSE + SEP + ENTITY_UNIT + SEP
      + COLON + ID_UNIT + SEP + ENTITY_LESSON + SEP + COLON + ID_LESSON + SEP + ENTITY_ASSESSMENT
      + SEP + COLON + ID_COLLECTION + SEP + PERFORMANCE;

  public static final String ALL_STUDENT_COLLECTION_PERF_GET = API_BASE_ROUTE + ENTITY_CLASS + SEP
      + COLON + ID_CLASS + SEP + ENTITY_COURSE + SEP + COLON + ID_COURSE + SEP + ENTITY_UNIT + SEP
      + COLON + ID_UNIT + SEP + ENTITY_LESSON + SEP + COLON + ID_LESSON + SEP + ENTITY_COLLECTION
      + SEP + COLON + ID_COLLECTION + SEP + PERFORMANCE;
  ...
  public static final String STUDENT_GRADE_BY_TEACHER_GET =
      API_BASE_ROUTE + ENTITY_USER + SEP + COLON + UID_USER + SEP + GRADE;
  ...
  public static final String SESSION_TAXONOMY_REPORT_GET =
      API_BASE_ROUTE + SESSION + SEP + COLON + ID_SESSION + SEP + TAXONOMY + SEP + USAGE;

  // Get Student Performance for All Classes
  // {REST_END_POINT}/api/nucleus-insights/v2/classes/performance
  public static final String ALL_CLASSES_PERFORMANCE = API_BASE_ROUTE + CLASSES + SEP + PERFORMANCE;

  // Get Student Current Location for All Classes
  public static final String STUDENT_LOCATION_ALL_CLASSES =
      API_BASE_ROUTE + CLASSES + SEP + LOCATION;

  // REMOVE
  public static final String STUDENT_PERF_MULTIPLE_COLLECTIONS =
      API_BASE_ROUTE + ENTITY_COLLECTION + SEP + PERFORMANCE;

  public static final String STUDENT_PERF_COURSE_ASSESSMENTS =
      API_BASE_ROUTE + STUDY + SEP + ENTITY_ASSESSMENT + SEP + PERFORMANCE;

  public static final String STUDENT_PERF_COURSE_COLLECTION =
      API_BASE_ROUTE + STUDY + SEP + ENTITY_COLLECTION + SEP + PERFORMANCE;
  ...
  public static final String COURSE_LEARNER_PERF_GET =
      API_BASE_ROUTE + ENTITY_COURSE + SEP + COLON + ID_COURSE + SEP + LEARNER + SEP + PERFORMANCE;
  ...
  public static final String UNIT_LEARNER_PERF_GET = API_BASE_ROUTE + ENTITY_COURSE + SEP + COLON
      + ID_COURSE + SEP + ENTITY_UNIT + SEP + COLON + ID_UNIT + SEP + LEARNER + SEP + PERFORMANCE;
  ...
  public static final String LESSON_LEARNER_PERF_GET = API_BASE_ROUTE + ENTITY_COURSE + SEP + COLON
      + ID_COURSE + SEP + ENTITY_UNIT + SEP + COLON + ID_UNIT + SEP + ENTITY_LESSON + SEP + COLON
      + ID_LESSON + SEP + LEARNER + SEP + PERFORMANCE;
  ...
  public static final String ASSESSMENT_LEARNER_PERF_GET =
      API_BASE_ROUTE + ENTITY_COURSE + SEP + COLON + ID_COURSE + SEP + ENTITY_UNIT + SEP + COLON
          + ID_UNIT + SEP + ENTITY_LESSON + SEP + COLON + ID_LESSON + SEP + ENTITY_ASSESSMENT + SEP
          + COLON + ID_COLLECTION + SEP + LEARNER + SEP + PERFORMANCE;

  // Get Learner Performance In Lesson (getLessonPerformance)
  // {REST_END_POINT}/api/nucleus-insights/v2//assessment/{assessmentGooruId}/learner/performance
  public static final String INDEPENDENT_ASSESSMENT_LEARNER_PERF_GET = API_BASE_ROUTE
      + ENTITY_ASSESSMENT + SEP + COLON + ID_COLLECTION + SEP + LEARNER + SEP + PERFORMANCE;
  ...
  public static final String GET_INDEPENDENT_LEARNER_COURSES =
      API_BASE_ROUTE + LEARNER + SEP + ENTITY_COURSES;
  ...
  public static final String INDENDEPENDENT_LEARNER_COLLECTION_SUMMARY_GET = API_BASE_ROUTE
      + ENTITY_COLLECTION + SEP + COLON + ID_COLLECTION + SEP + LEARNER + SEP + COLON + ID_USER;

  public static final String INDENDEPENDENT_LEARNER_ASSESSMENT_SUMMARY_GET = API_BASE_ROUTE
      + ENTITY_ASSESSMENT + SEP + COLON + ID_ASSESSMENT + SEP + LEARNER + SEP + COLON + ID_USER;

  // GET ALL USER SESSIONS
  // {REST_END_POINT}/insights/api/v2/learner/{collectionType}/{contentGooruId}/sessions
  public static final String INDEPENDENT_LEARNER_ALL_SESSION_FOR_ASSESSMENT_GET = API_BASE_ROUTE
      + LEARNER + SEP + ENTITY_ASSESSMENT + SEP + COLON + ID_COLLECTION + SEP + SESSIONS;

  public static final String INDEPENDENT_LEARNER_ALL_SESSION_FOR_COLLECTION_GET = API_BASE_ROUTE
      + LEARNER + SEP + ENTITY_COLLECTION + SEP + COLON + ID_COLLECTION + SEP + SESSIONS;
  ...
  public static final String LEARNER_LOCATION_ALL_COURSES_GET =
      API_BASE_ROUTE + LEARNER + SEP + ENTITY_COURSES + SEP + LOCATION;

  // Get Independent Learner's Location for all Assessments (ClassId = null, CourseId = null, UnitId
  // = null, LessonId = null)
  // {REST_END_POINT}/api/nucleus-insights/v2/learner/assessments/location
  public static final String LEARNER_LOCATION_ALL_IND_ASSESSMENTS_GET =
      API_BASE_ROUTE + LEARNER + SEP + ENTITY_ASSESSMENTS + SEP + LOCATION;

  // Get Independent Learner's Location for all Collections (ClassId = null, CourseId = null, UnitId
  // = null, LessonId = null)
  // {REST_END_POINT}/api/nucleus-insights/v2/learner/collections/location
  public static final String LEARNER_LOCATION_ALL_IND_COLLECTIONS_GET =
      API_BASE_ROUTE + LEARNER + SEP + ENTITY_COLLECTIONS + SEP + LOCATION;
  ...
  public static final String LEARNER_PERF_ALL_COURSES_GET =
      API_BASE_ROUTE + LEARNER + SEP + ENTITY_COURSES + SEP + PERFORMANCE;

  // Get Independent Learner's Performance for all Assessments (ClassId = null, CourseId = null,
  // UnitId = null, LessonId = null)
  // {REST_END_POINT}/api/nucleus-insights/v2/learner/assessments/performance
  public static final String LEARNER_PERF_ALL_IND_ASSESSMENTS_GET =
      API_BASE_ROUTE + LEARNER + SEP + ENTITY_ASSESSMENTS + SEP + PERFORMANCE;

  // Get Independent Learner's Performance for all Collections (ClassId = null, CourseId = null,
  // UnitId = null, LessonId = null)
  // {REST_END_POINT}/api/nucleus-insights/v2/learner/collections/performance
  public static final String LEARNER_PERF_ALL_IND_COLLECTIONS_GET =
      API_BASE_ROUTE + LEARNER + SEP + ENTITY_COLLECTIONS + SEP + PERFORMANCE;
  ...
  public static final String LEARNER_PERF_COURSE_COLLECTIONS_GET =
      API_BASE_ROUTE + LEARNER + SEP + ENTITY_COURSE + SEP + ENTITY_COLLECTIONS + SEP + PERFORMANCE;

  // Get Independent Learner's Performance for all Collections in a Course (ClassId = null)
  // {REST_END_POINT}/api/nucleus-insights/v2/learner/course/assessments/performance
  public static final String LEARNER_PERF_COURSE_ASSESSMENTS_GET =
      API_BASE_ROUTE + LEARNER + SEP + ENTITY_COURSE + SEP + ENTITY_ASSESSMENTS + SEP + PERFORMANCE;

  // GET LIST OF SUBJECTS STUDIED BY THE USER
  public static final String LEARNER_TAXONOMY_SUBJECTS =
      API_BASE_ROUTE + LEARNER + SEP + TAXONOMY + SEP + ENTITY_TX_SUBJECT;

  // Get learner courses...
  // {REST_END_POINT}/api/nucleus-insights/v2/user/courses
  public static final String LEARNER_COURSES_GET =
      API_BASE_ROUTE + ENTITY_USER + SEP + ENTITY_COURSES;

  // Get Independent Learner's Location for all Courses, Standalone Assessments, standalone
  // Collections (ClassId = null)
  // {REST_END_POINT}/api/nucleus-insights/v2/learner/location
  public static final String INDEPENDENT_LEARNER_LOCATION_ALL_GET =
      API_BASE_ROUTE + LEARNER + SEP + LOCATION;

  // Get Independent Learner's Performance for all Courses Standalone Assessments, standalone
  // Collections (ClassId = null)
  // {REST_END_POINT}/api/nucleus-insights/v2/learner/performance
  public static final String INDEPENDENT_LEARNER_PERF_ALL_GET =
      API_BASE_ROUTE + LEARNER + SEP + PERFORMANCE;

  // ***********************************************************************************************

  // Get Independent Learner Performance for All Courses
  // {REST_END_POINT}/api/nucleus-insights/v2/courses/learner/performance
  public static final String INDEPENDENT_LEARNER_PERF_ALL_COURSES =
      API_BASE_ROUTE + ENTITY_COURSES + SEP + LEARNER + SEP + PERFORMANCE;
  ...
  public static final String INDEPENDENT_LEARNER_CURRENT_LOC_GET =
      API_BASE_ROUTE + ENTITY_COURSE + SEP + COLON + ID_COURSE + SEP + ENTITY_USER + SEP + COLON
          + ID_USER + SEP + LEARNER + SEP + CURRENT + SEP + LOCATION;
  ...
  public static final String STUDENT_PERF_DAILY_CLASS_ACTIVITY =
      API_BASE_ROUTE + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + ACTIVITY;
  ...
  public static final String STUDENT_PERF_DAILY_TIMELY_CLASS_ACTIVITY =
      API_BASE_ROUTE + DCA + SEP + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + REPORT;

  // Get Student Session wise taxonomy report (getSessionTaxonomyReport)
  // {REST_END_POINT}/api/nucleus-insights/v2/dca/session/{sessionId}/taxonomy/usage
  public static final String DCA_SESSION_TAXONOMY_REPORT_GET = API_BASE_ROUTE + DCA + SEP + SESSION
      + SEP + COLON + ID_SESSION + SEP + TAXONOMY + SEP + USAGE;

  // Get Student Performance In Collection/Assessment (getCollectionPeformance)
  // {REST_END_POINT}/api/nucleus-insights/v2/dca/{collectionType}/{contentGooruId}/user/{userUid}
  public static final String DCA_COLLECTION_STUDENT_SUMMARY_GET = API_BASE_ROUTE + DCA + SEP
      + ENTITY_COLLECTION + SEP + COLON + ID_COLLECTION + SEP + ENTITY_USER + SEP + COLON + ID_USER;

  public static final String DCA_ASSESSMENT_STUDENT_SUMMARY_GET = API_BASE_ROUTE + DCA + SEP
      + ENTITY_ASSESSMENT + SEP + COLON + ID_ASSESSMENT + SEP + ENTITY_USER + SEP + COLON + ID_USER;
  ...
  public static final String DCA_ASSESSMENT_STUDENTS_PERF_GET =
      API_BASE_ROUTE + DCA + SEP + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + ENTITY_ASSESSMENT
          + SEP + COLON + ID_COLLECTION + SEP + PERFORMANCE;

  // Get Students Performance In an Assessment (Teacher View)
  // {REST_END_POINT}/api/nucleus-insights/v2/dca/class/{classGooruId}/collection/{collectionGooruId}/performance
  public static final String DCA_COLLECTION_STUDENTS_PERF_GET =
      API_BASE_ROUTE + DCA + SEP + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + ENTITY_COLLECTION
          + SEP + COLON + ID_COLLECTION + SEP + PERFORMANCE;

  // GET ALL USER SESSIONS
  // {REST_END_POINT}/api/nucleus-insights/v2/dca/{collectionType}/{contentGooruId}/sessions
  public static final String DCA_USER_ALL_SESSIONS_GET_FOR_ASSESSMENT =
      API_BASE_ROUTE + DCA + SEP + ENTITY_ASSESSMENT + SEP + COLON + ID_COLLECTION + SEP + SESSIONS;

  // Get Student Performance in a Class
  // {REST_END_POINT}/api/nucleus-insights/v2/dca/class/:classId/performance
  public static final String DCA_CLASS_PERFORMANCE =
      API_BASE_ROUTE + DCA + SEP + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + PERFORMANCE;

  // {REST_END_POINT}/api/nucleus-insights/v2/dca/class/:classId/summary
  public static final String DCA_CLASS_SUMMARY_FOR_YEAR =
      API_BASE_ROUTE + DCA + SEP + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + SUMMARY;

  // {REST_END_POINT}/api/nucleus-insights/v2/dca/class/:classId/activities/summary
  public static final String DCA_CLASS_ACTIVITIES_SUMMARY_FOR_MONTH = API_BASE_ROUTE + DCA + SEP
      + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + ACTIVITIES + SEP + SUMMARY;

  // {REST_END_POINT}/api/nucleus-insights/v2/dca/class/:classId/:collectionType/:collectionId/learners/summary
  public static final String DCA_CLASS_LEARNERS_SUMMARY_FOR_MONTH =
      API_BASE_ROUTE + DCA + SEP + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + COLON
          + COLLECTION_TYPE + SEP + COLON + ID_COLLECTION + SEP + LEARNERS + SEP + SUMMARY;

  // {REST_END_POINT}/api/nucleus-insights/v2/dca/class/{classGooruId}/assessment/{assessmentGooruId}/session/{sessionId}/performance
  public static final String CA_ASSESSMENT_STUDENTS_SESSION_PERF_GET = API_BASE_ROUTE + DCA + SEP
      + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + ENTITY_ASSESSMENT + SEP + COLON
      + ID_COLLECTION + SEP + SESSION + SEP + COLON + ID_SESSION + SEP + PERFORMANCE;
  // {REST_END_POINT}/api/nucleus-insights/v2/dca/class/{classGooruId}/collection/{collectionGooruId}/session/{sessionId}/performance
  public static final String CA_COLLECTION_STUDENTS_SESSION_PERF_GET = API_BASE_ROUTE + DCA + SEP
      + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + ENTITY_COLLECTION + SEP + COLON
      + ID_COLLECTION + SEP + SESSION + SEP + COLON + ID_SESSION + SEP + PERFORMANCE;
  ...
  public static final String RUBRICS_QUESTIONS_TO_GRADE_GET =
      API_BASE_ROUTE + RUBRICS + SEP + ENTITY_QUESTIONS;
  ...
  public static final String RUBRIC_QUESTION_TO_GRADE_LIST_STUDENTS_GET = API_BASE_ROUTE + RUBRICS
  ...
  public static final String RUBRIC_QUESTION_STUDENT_ANSWERS_GET =
      API_BASE_ROUTE + RUBRICS + SEP + ENTITY_QUESTIONS + SEP + COLON + QUE_ID + SEP
  ...
  public static final String RUBRIC_QUESTION_GRADE_SUMMARY_GET =
      API_BASE_ROUTE + RUBRICS + SEP + ENTITY_CLASS + SEP + COLON + ID_CLASS + SEP + ENTITY_COURSE
  ...
  public static final String DATA_REPORTS_FOR_STUDENT =
      API_BASE_ROUTE_III + ENTITY_STUDENT + SEP + PERFORMANCE;

  // Courses Competency Completion
  // {REST_END_POINT}/api/nucleus-insights/v3/courses/competency-completion
  public static final String NU_COURSES_COMPETENCY_COMPLETION =
      API_BASE_ROUTE_III + COURSES + SEP + COMPETENCY + HYPHEN + COMPLETION;
  ...
  public static final String STUDENTS_PERFORMANCE_VS_COMPLETION =
      API_BASE_ROUTE + ATC + SEP + PERF_VS_COMP;

  // {REST_END_POINT}/api/nucleus-insights/v2/class/{classId}/items/performance
  public static final String STUDENTS_COURSE_ALL_ITEMS_PERF = API_BASE_ROUTE + ENTITY_CLASS + SEP
      + COLON + ID_CLASS + SEP + ENTITY_ITEMS + SEP + PERFORMANCE;
